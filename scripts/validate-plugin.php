...
if (($manifest['id'] ?? null) !== 'seerr-to-m3ue-sync') {
    fwrite(STDERR, "Expected plugin id seerr-to-m3ue-sync, found ".($manifest['id'] ?? 'unknown')."\n");
    exit(1);
}
...
echo "Validated seerr-to-m3ue-sync plugin files.\n";
